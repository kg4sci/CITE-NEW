...
def run_eval(args, num_gpus):
    ...
    print(len(prompt_file))# 3431
    chunk_size = len(prompt_file) // num_gpus #每个gpu上面有多少个内容
    print("chunk_size",chunk_size) #3431
    ans_handles = []
    split_list = list(range(args.start_id, args.end_id, chunk_size))#首、末、步长
