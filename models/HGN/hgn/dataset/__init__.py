...
# from .Chemistry_dataset111 import ChemistryDataset
...
def build_dataset_GB(dataset,*args,**kwargs):
    ...
    if dataset in ['imdb4GTN','HGBl-amazon']:
        print("dataset == imdb4GTN or HGBl-amazon")
...
#######  add  dataset  here
    ...
    # if dataset == 'my_custom_node_classification':
    #     _dataset = 'my_custom_node_classification'
...
##########
                     ...
                     'amazon', 'yelp4HGSL','my_custom_node_classification']:
        _dataset = 'hin_' + task
